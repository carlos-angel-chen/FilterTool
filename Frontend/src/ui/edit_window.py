...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.aproximation_select_2.setStyleSheet("background:white;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_26.setText(_translate("Form", "Tolerance"))
        self.label_4.setText(_translate("Form", "Error: Los datos no son válidos para crear la curva"))

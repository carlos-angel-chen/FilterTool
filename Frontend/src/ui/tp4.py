...
"")
        ...
        self.type_graph_select.setStyleSheet("background:rgb(30,30,30);\n"
"color:white;")
        ...
        self.filter_select.setStyleSheet("background:rgb(30,30,30);\n"
"color:white;")
        ...
        self.aproximation_select.setStyleSheet("background:rgb(30,30,30);\n"
"color:white;")
        ...
        self.aproximation_select_2 = QtWidgets.QComboBox(Form)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.aproximation_select_2.setFont(font)
        self.aproximation_select_2.setStyleSheet("background:rgb(30,30,30);\n"
"color:white;")
        self.aproximation_select_2.setObjectName("aproximation_select_2")
        self.aproximation_select_2.addItem("")
        self.aproximation_select_2.addItem("")
        self.horizontalLayout_17.addWidget(self.aproximation_select_2)
        ...
        self.Aa_Valor.setMaximum(2000000000.0)
        ...
        self.Ap_valor.setMaximum(2000000000.0)
        ...
        self.fa_valor.setMaximum(2000000000.0)
        ...
        self.fp_valor.setMaximum(2000000000.0)
        ...
        self.fa_mas_valor.setMaximum(2000000000.0)
        ...
        self.fa_menos_valor.setMaximum(2000000000.0)
        ...
        self.fp_mas_valor.setMaximum(2000000000.0)
        ...
        self.fp_menos_valor.setMaximum(2000000000.0)
        ...
        self.GD_value = QtWidgets.QDoubleSpinBox(self.widget_4)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.GD_value.setFont(font)
        self.GD_value.setStyleSheet("background:white;")
        self.GD_value.setDecimals(6)
        self.GD_value.setMaximum(2000000000.0)
        self.GD_value.setObjectName("GD_value")
        self.horizontalLayout_30.addWidget(self.GD_value)
        ...
        self.tolerance_value = QtWidgets.QDoubleSpinBox(self.widget_4)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.tolerance_value.setFont(font)
        self.tolerance_value.setStyleSheet("background:white;")
        self.tolerance_value.setMaximum(100.0)
        self.tolerance_value.setObjectName("tolerance_value")
        self.horizontalLayout_29.addWidget(self.tolerance_value)
        ...
        self.Toolbar1.addItem(spacerItem1)
        ...
        self.Template_checkbox = QtWidgets.QCheckBox(Form)
        self.Template_checkbox.setText("")
        self.Template_checkbox.setObjectName("Template_checkbox")
        self.horizontalLayout_4.addWidget(self.Template_checkbox)
        ...
        self.Curve_List_Select.setStyleSheet("background:rgb(30,30,30);\n"
"color:white;")
...
"color:white;")
        ...
        self.N_min_slider_2.valueChanged['int'].connect(self.N_min_box_2.setValue) # type: ignore
        self.N_min_box_2.valueChanged['int'].connect(self.N_min_slider_2.setValue) # type: ignore
        self.Q_slider.valueChanged['int'].connect(self.Q_box.setValue) # type: ignore
        self.Q_box.valueChanged['int'].connect(self.Q_slider.setValue) # type: ignore
        self.N_max_slider.valueChanged['int'].connect(self.N_max_box.setValue) # type: ignore
        self.N_max_box.valueChanged['int'].connect(self.N_max_slider.setValue) # type: ignore
        self.Denom_slider.valueChanged['int'].connect(self.Denom_box.setValue) # type: ignore
        self.Denom_box.valueChanged['int'].connect(self.Denom_slider.setValue) # type: ignore
    ...
    def retranslateUi(self, Form):
        ...
        self.type_graph_select.setItemText(3, _translate("Form", "Group Delay"))
        self.type_graph_select.setItemText(4, _translate("Form", "Zeros and Poles"))
        ...
        self.aproximation_select_2.setItemText(0, _translate("Form", "Bessel"))
        self.aproximation_select_2.setItemText(1, _translate("Form", "Gauss"))
        ...
        self.label_24.setText(_translate("Form", "GD"))
        self.label_25.setText(_translate("Form", "Tolerance"))
        self.label_3.setText(_translate("Form", "Error: Los datos no son válidos para crear la curva"))
        self.label_26.setText(_translate("Form", "Template"))
